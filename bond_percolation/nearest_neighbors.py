...
#another nearest function defined for conveneince 
def nearest2(size,point):
    ...
    return [[point,roll_right[X[0],X[1]]],[point,roll_down[X[0],X[1]]]]

#call function to return all the bonds in a lattice os size numb
def nearest_bonds(numb):
    X = []
